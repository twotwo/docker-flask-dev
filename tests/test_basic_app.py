# https://github.com/pallets/flask-sqlalchemy/blob/master/tests/test_basic_app.py
import flask
...
def test_sqlite_relative_path(app, tmp_path):
    ...
    SQLAlchemy(app).get_engine()
    print(f"app.instance_path={app.instance_path}, is exists? {app.instance_path.exists()}")
